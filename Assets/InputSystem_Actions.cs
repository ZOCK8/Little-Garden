...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""lol"",
            ""id"": ""727bef5f-273b-4315-9fd4-3e864651e08c"",
            ""actions"": [
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""98798a54-521a-4e18-8a64-ad32b7f5b951"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""41226459-8e8d-496b-844a-a613d637e59c"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_lol_Newaction = m_lol.FindAction("New action", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_lol.enabled, "This will cause a leak and performance issues, InputSystem_Actions.lol.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_lol_Newaction;
    /// <summary>
    /// Provides access to input actions defined in input action map "lol".
    /// </summary>
    public struct LolActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public LolActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "lol/Newaction".
        /// </summary>
        public InputAction @Newaction => m_Wrapper.m_lol_Newaction;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="LolActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="LolActions.UnregisterCallbacks(ILolActions)" />.
        /// </summary>
        /// <seealso cref="LolActions.UnregisterCallbacks(ILolActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="LolActions.AddCallbacks(ILolActions)" />
        /// <seealso cref="LolActions.RemoveCallbacks(ILolActions)" />
        /// <seealso cref="LolActions.UnregisterCallbacks(ILolActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="LolActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "lol" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="LolActions.AddCallbacks(ILolActions)" />
    /// <seealso cref="LolActions.RemoveCallbacks(ILolActions)" />
